  ...
  return (
    <>
      ...
      <header data-vue="header" className={styles.layoutHeader}>
        <div className={`${styles.siteHeader} ${styles.siteHeaderTransparent} ${styles.siteHeaderMobileTransparent}`}>
          <div className={styles.siteHeaderWrapper}>
            ...
            {/* Navigation - First (for mobile/scripts) - Inside Wrapper */}
            <div className={styles.siteHeaderNavigation}>
              <div className={styles.siteHeaderMenuMobile}>
                <div id="shopify-section-header-menu--mobile" className={styles.shopifySection}>
                  {/* Mobile menu section - empty for now */}
          </div>
                ...
                <script type="application/ld+json" dangerouslySetInnerHTML={{
                  __html: JSON.stringify({
                    ...
                    "@type": "Organization",
                    "name": "AURAPOP",
                    "description": "Shop AURAPOP featuring award-winning beauty products, skincare, makeup, and more.",
                    "url": typeof window !== 'undefined' ? window.location.origin : '',
                    "logo": typeof window !== 'undefined' ? window.location.origin : '',
                    "sameAs": []
                  })
                }} />
                <script type="application/ld+json" dangerouslySetInnerHTML={{
                  __html: JSON.stringify({
                    ...
                    "potentialAction": {
                      "@type": "SearchAction",
                      "target": typeof window !== 'undefined' ? `${window.location.origin}/search?q={query}` : '/search?q={query}',
            ...
            <div className={`${styles.siteHeaderUtilities} ${styles.siteHeaderUtilitiesDesktop}`}>
              ...
              <div className={styles.siteHeaderActionGroup}>
                <Link
                  to="/wishlist"
                  className={`${styles.siteHeaderAction} ${styles.siteHeaderActionWishlist} ${styles.siteHeaderActionWishlistMobile}`}
                  title="Wishlist"
                  aria-label="Product Added in Wishlist"
                  rel="nofollow"
                >
          ...
          {/* Desktop Navigation - Outside Wrapper but Inside site-header */}
          <div className={`${styles.siteHeaderNavigation} ${styles.siteHeaderNavigationDesktop}`}>
